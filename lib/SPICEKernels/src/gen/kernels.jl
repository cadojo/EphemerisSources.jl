...
This kernel's link was sourced on 2026-09-15.
...
"""
A FK kernel of size 0.5 KB, linked from https://naif.jpl.nasa.gov [1].
Calling this variable like a function will return a path to the file, downloading 
to scratchspace if necessary.
...
[1] https://naif.jpl.nasa.gov/pub/naif/generic_kernels/fk/satellites/jup348_nameid.tf
...
```
"""
const jup348_nameid = FK("https://naif.jpl.nasa.gov/pub/naif/generic_kernels/fk/satellites/jup348_nameid.tf")

"""
A FK kernel of size 1.3 KB, linked from https://naif.jpl.nasa.gov [1].
Calling this variable like a function will return a path to the file, downloading 
to scratchspace if necessary.
...
[1] https://naif.jpl.nasa.gov/pub/naif/generic_kernels/fk/satellites/jup349_nameid.tf
...
```
"""
const jup349_nameid = FK("https://naif.jpl.nasa.gov/pub/naif/generic_kernels/fk/satellites/jup349_nameid.tf")
...
[1] https://naif.jpl.nasa.gov/pub/naif/generic_kernels/fk/satellites/sat458_nameid.tf
...
```
"""
const sat458_nameid = FK("https://naif.jpl.nasa.gov/pub/naif/generic_kernels/fk/satellites/sat458_nameid.tf")

"""
A FK kernel of size 1.6 KB, linked from https://naif.jpl.nasa.gov [1].
Calling this variable like a function will return a path to the file, downloading 
to scratchspace if necessary.
...
[1] https://naif.jpl.nasa.gov/pub/naif/generic_kernels/fk/satellites/sat459_nameid.tf
...
```
"""
const sat459_nameid = FK("https://naif.jpl.nasa.gov/pub/naif/generic_kernels/fk/satellites/sat459_nameid.tf")
...
"""
A FK kernel of size 67.8 KB, linked from https://naif.jpl.nasa.gov [1].
Calling this variable like a function will return a path to the file, downloading 
to scratchspace if necessary.
...
[1] https://naif.jpl.nasa.gov/pub/naif/generic_kernels/fk/stations/earth_topo_260814.tf
...
```
"""
const earth_topo_260814 = FK("https://naif.jpl.nasa.gov/pub/naif/generic_kernels/fk/stations/earth_topo_260814.tf")
...
"""
A PCK kernel of size 29.9 MB, linked from https://naif.jpl.nasa.gov [1].
Calling this variable like a function will return a path to the file, downloading 
to scratchspace if necessary.
...
[1] https://naif.jpl.nasa.gov/pub/naif/generic_kernels/pck/earth_1962_260806_2126_combined.bpc
...
Summary for: earth_1962_260806_2126_combined.bpc
 
Frame: ITRF93 (3000)
       Start of Interval (ET)              End of Interval (ET)
       -----------------------------       -----------------------------
       1962 JAN 20 00:00:41.184            2126 NOV 03 00:01:09.182
 

```
"""
const earth_1962_260806_2126_combined = PCK("https://naif.jpl.nasa.gov/pub/naif/generic_kernels/pck/earth_1962_260806_2126_combined.bpc")
...
[1] https://naif.jpl.nasa.gov/pub/naif/generic_kernels/pck/earth_2026_260806_2126_predict.bpc
...
Summary for: earth_2026_260806_2126_predict.bpc
 
Frame: ITRF93 (3000)
       Start of Interval (ET)              End of Interval (ET)
       -----------------------------       -----------------------------
       2026 JAN 01 00:01:09.183            2126 NOV 03 00:01:09.182
 

```
"""
const earth_2026_260806_2126_predict = PCK("https://naif.jpl.nasa.gov/pub/naif/generic_kernels/pck/earth_2026_260806_2126_predict.bpc")

"""
A PCK kernel of size 11.7 MB, linked from https://naif.jpl.nasa.gov [1].
Calling this variable like a function will return a path to the file, downloading 
to scratchspace if necessary.
...
[1] https://naif.jpl.nasa.gov/pub/naif/generic_kernels/pck/earth_620120_260806.bpc
...
Summary for: earth_620120_260806.bpc
 
Frame: ITRF93 (3000)
       Start of Interval (ET)              End of Interval (ET)
       -----------------------------       -----------------------------
       1962 JAN 20 00:00:41.184            2026 AUG 08 00:01:09.183
 

```
"""
const earth_620120_260806 = PCK("https://naif.jpl.nasa.gov/pub/naif/generic_kernels/pck/earth_620120_260806.bpc")
...
"""
A PCK kernel of size 4.9 MB, linked from https://naif.jpl.nasa.gov [1].
Calling this variable like a function will return a path to the file, downloading 
to scratchspace if necessary.
...
Frame: ITRF93 (3000)
       Start of Interval (ET)              End of Interval (ET)
       -----------------------------       -----------------------------
       2000 JAN 01 00:01:04.183            2026 DEC 11 00:01:09.183
...
[1] https://naif.jpl.nasa.gov/pub/naif/generic_kernels/spk/planets/de442.bsp
...
```
"""
const de442 = SPK("https://naif.jpl.nasa.gov/pub/naif/generic_kernels/spk/planets/de442.bsp")
...
"""
A SPK kernel of size 57.0 MB, linked from https://naif.jpl.nasa.gov [1].
Calling this variable like a function will return a path to the file, downloading 
to scratchspace if necessary.
...
[1] https://naif.jpl.nasa.gov/pub/naif/generic_kernels/spk/satellites/jup348.bsp
...
Summary for: jup348.bsp
 
Bodies: EARTH BARYCENTER (3)    EARTH (399)             55528
        JUPITER BARYCENTER (5)  JUPITER (599)           55529
        SUN (10)                55527                   55530
        Start of Interval (ET)              End of Interval (ET)
        -----------------------------       -----------------------------
        1799 JAN 16 00:00:00.000            2199 DEC 15 00:00:00.000
 

```
"""
const jup348 = SPK("https://naif.jpl.nasa.gov/pub/naif/generic_kernels/spk/satellites/jup348.bsp")

"""
A SPK kernel of size 93.0 MB, linked from https://naif.jpl.nasa.gov [1].
Calling this variable like a function will return a path to the file, downloading 
to scratchspace if necessary.
...
[1] https://naif.jpl.nasa.gov/pub/naif/generic_kernels/spk/satellites/jup349.bsp
...
Summary for: jup349.bsp
 
Bodies: EARTH BARYCENTER (3)    55533                   55540
        JUPITER BARYCENTER (5)  55534                   55541
        SUN (10)                55535                   55542
        EARTH (399)             55536                   55543
        JUPITER (599)           55537                   55544
        55531                   55538
        55532                   55539
        Start of Interval (ET)              End of Interval (ET)
        -----------------------------       -----------------------------
...
```
"""
const jup349 = SPK("https://naif.jpl.nasa.gov/pub/naif/generic_kernels/spk/satellites/jup349.bsp")
...
"""
A SPK kernel of size 80.4 MB, linked from https://naif.jpl.nasa.gov [1].
Calling this variable like a function will return a path to the file, downloading 
to scratchspace if necessary.
...
[1] https://naif.jpl.nasa.gov/pub/naif/generic_kernels/spk/satellites/sat459.bsp
...
Summary for: sat459.bsp
 
Bodies: EARTH BARYCENTER (3)   65289                  65297
        SATURN BARYCENTER (6)  65290                  65298
        SUN (10)               65291                  65299
        EARTH (399)            65292                  65300
        SATURN (699)           65293                  65301
        65286                  65294                  65302
        65287                  65295                  65303
        65288                  65296
        Start of Interval (ET)              End of Interval (ET)
        -----------------------------       -----------------------------
        1749 DEC 27 00:00:00.000            2150 JAN 05 00:00:00.000
...
[1] https://naif.jpl.nasa.gov/pub/naif/generic_kernels/spk/stations/earthstns_fx_260814.bsp
...
Summary for: earthstns_fx_260814.bsp
...
```
"""
const earthstns_fx_260814 = SPK("https://naif.jpl.nasa.gov/pub/naif/generic_kernels/spk/stations/earthstns_fx_260814.bsp")
...
[1] https://naif.jpl.nasa.gov/pub/naif/generic_kernels/spk/stations/earthstns_itrf93_260814.bsp
...
Summary for: earthstns_itrf93_260814.bsp
...
```
"""
const earthstns_itrf93_260814 = SPK("https://naif.jpl.nasa.gov/pub/naif/generic_kernels/spk/stations/earthstns_itrf93_260814.bsp")
...
export
    ...
    Gravity,
    de_403_masses,
    earth_1962_260806_2126_combined,
    earth_2026_260806_2126_predict,
    earth_620120_260806,
    earth_fixed,
